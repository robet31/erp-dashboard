...
// Sebelumnya kamu memakai getDynamicCompany manual, ubah menjadi ini:
const getDynamicCompany = (warehouses: any[]) => {
  const validWarehouse = warehouses?.find((w: any) => !w.is_group && w.company);
  return validWarehouse ? validWarehouse.company : 'Artavista';
};
    ...
    <div className="tw-root" style={{ fontFamily: "'Inter', 'Poppins', sans-serif", animation: 'fadeIn 0.4s ease-out' }}>
      ...
      <div className="tw-table-wrapper">
        ...
        <div className="tw-table-filters" style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '20px' }}>
          ...
          {/* BARIS 2: Filter & Sortir */}
          {activeTab === 'orders' && (
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', alignItems: 'center', width: '100%' }}>
              {/* Area Filter Pill (Bisa di-swipe horizontal) */}
              <div className="hide-scrollbar" style={{ display: 'flex', gap: '6px', overflowX: 'auto', maxWidth: '100%', paddingBottom: '4px' }}>
