...
import {
  LayoutDashboard, ShoppingCart, Package, Cog, LogOut, BarChart2, ChevronRight, Wrench, Users
} from 'lucide-react';
    ...
    <aside style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div>
            <div style={{ fontSize: '14px', fontWeight: 800, color: '#111827', lineHeight: 1.1 }}>ERP DASHBOARD</div>
            ...
            >
              ...
              {active && (
                <div style={{
                  ...
                  background: '#0066B3', borderRadius: '2px 0 0 2px',
                }} />
              )}
            </Link>
          );
